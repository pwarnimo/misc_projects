...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SpinBox_t, stringdata) + ofs \
...
const QMetaObject SpinBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SpinBox.data,
      qt_meta_data_SpinBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SpinBox.stringdata))
